...
general_log = logger_setup(' Response Router 2 ','/logs/rr2.log')
time_log = logger_setup(' Timing Response Router 2 ','/logs/rr2time.log')
...
if __name__ == '__main__':
  ...
  app = make_app()
  app.listen(3001)
  print("Started Response Router 2 REST Server")
  client_pub = Publisher("message-broker-2-service.clm-test.empower:5672")
